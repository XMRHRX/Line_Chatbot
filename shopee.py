...
class Shopee(Shop):
    ...
    #綜合排名：relevancy    價格：price    新上市：ctime    最熱銷：sales
    ...
    def Search(self):
        ...
        #生成網址
        url = 'https://shopee.tw/api/v2/search_items/?by='+self.search_by+'&keyword='+urllib.parse.quote(self.target)+'&limit='+str(self.request_num)+'&newest=0&order='+self.order_by+'&page_type=search'
